                            ...
                            <>
                                <div className="grid gap-4 py-4">
                                    ...
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        ...
                                        <div className="col-span-3">{selectedPatient.medical_conditions.join(", ")}</div>
                                    </div>
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        <Label className="text-right">Doctor</Label>
                                        <div className="col-span-3">{selectedPatient.assigned_doctor || "N/A"}</div>
                                    </div>
                                    <div className="grid grid-cols-4 items-center gap-4">
                                        <Label className="text-right">Device ID</Label>
                                        <div className="col-span-3">{selectedPatient.device_id || "N/A"}</div>
                                    </div>
                                </div>
                                <DialogFooter>
                                    <Button variant="destructive" onClick={() => handleDeletePatient(selectedPatient._id)}>
                                        Delete
                                    </Button>
                                </DialogFooter>
                            </>
